...
export function useToast() {
  ...
  const node =
    mounted && msg
      ? createPortal(
          <div className="fixed bottom-6 left-1/2 z-[110] -translate-x-1/2 rounded-xl bg-[#1A1C1E] px-4 py-2.5 text-[13px] font-medium text-white shadow-[0_12px_40px_-12px_rgba(26,28,30,0.5)]">
            {msg}
          </div>,
          document.body,
        )
      ...
      {mounted && open
        ? createPortal(
            <>
              ...
              <div
                style={{ position: 'fixed', top: pos.top, left: pos.left, zIndex: 96 }}
