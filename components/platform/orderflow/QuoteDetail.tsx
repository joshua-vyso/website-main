  ...
  if (!quote) {
    return (
      <div className="rounded-2xl border border-dashed border-[#E2E6EC] bg-[#FBFCFE] px-6 py-12 text-center">
        <p className="text-[15px] font-medium text-[#171A17]">Quote not found</p>
    ...
    <div className="space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {eff === 'draft' ? (
            <button
              ...
              disabled={!!busy}
              className="inline-flex h-9 items-center rounded-lg border border-[#E2E6EC] bg-white px-3.5 text-[13px] font-medium text-[#171A17] transition-colors hover:border-[#3E7BC4]/50 disabled:opacity-50"
            >
      ...
      {q.converted_order_id ? (
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-[#D6E7DF] bg-[#F1F7F4] px-4 py-3 text-[13px]">
          <span className="text-[#171A17]">This quote was converted to an order.</span>
      ...
      {q.converted_invoice_id ? (
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-[#D6E7DF] bg-[#F1F7F4] px-4 py-3 text-[13px]">
          <span className="text-[#171A17]">This quote was converted to an invoice.</span>
