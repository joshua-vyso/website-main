    ...
    <div className="mt-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={creating}
          className="rounded-lg bg-[#1E5E54] px-4 py-2 text-[13px] font-medium text-white transition-colors hover:bg-[#184D45] disabled:opacity-50"
        >
      ...
      {recipes.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-[#E7E7E2] bg-white px-8 py-16 text-center">
          ...
          <button
            ...
            onClick={() => void newRecipe()}
            disabled={creating}
            className="mt-5 inline-flex items-center justify-center rounded-lg bg-[#1E5E54] px-4 py-2.5 text-[14px] font-medium text-white transition-colors hover:bg-[#184D45] disabled:opacity-50"
          >
          ...
          {recipes.map((r) => {
            ...
            return (
              <Link
                ...
                className="group flex flex-col rounded-2xl border border-[#E7E7E2] bg-white p-4 transition-colors hover:border-[#1E5E54]/40"
              >
