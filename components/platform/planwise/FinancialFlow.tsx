        ...
        <div className="border-t border-[#F0F0EC] p-5">
          <div className="flex flex-wrap items-stretch gap-2">
            {financialFlow.map((n, i) => {
              ...
              const inner = (
                <div className={`flex h-full min-w-[120px] flex-col rounded-xl border bg-white px-3.5 py-2.5 transition-all ${isExpanded ? 'border-[#3E7BC4] ring-1 ring-[#3E7BC4]/15' : 'border-[#E7E7E2] hover:border-[#3E7BC4]/40'}`}>
              ...
              return (
                <div className="mt-4 rounded-xl bg-[#FCFCFB] p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-6">
                    {node.children.map((c) => {
                      const body = (
                        <div className="rounded-lg border border-[#F0F0EC] bg-white px-3 py-2.5 transition-colors hover:border-[#3E7BC4]/30">
